        ...
        <section class="pt-100 ct-01 content-section division">
            <div class="container">
                <div class="row d-flex align-items-center">
                    <!-- Preview Image -->
                    <img class="img-fluid r-30" src="assets/images/bg-about.jpg" alt="video-preview">
                </div> <!-- End row -->
            </div> <!-- End container -->
        </section> <!-- END IMAGE -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-9">
                        <div class="section-title mb-70">
                            ...
                            <!-- Title -->
                            <h2 class="s-40 w-700">Why Would You Choose Us?</h2>

                            <!-- Text -->
                            <p class="s-21 color--grey">As a trusted partner in e-commerce and digital marketing
                                solutions, Be Professional is accredited as an Amazon SPN (Service Provider Network) and
                                Amazon ATES (Amazon Trained E-Commerce Specialist), as well as a Flipkart Partner for
                                Services. With our expertise and support, we assure your success. By choosing Be
                                Professional,
                                you are not only aligning with a reliable partner but also unlocking the potential to
                                expand your business on a global scale.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div id="a3-1" class="txt-block">
                            ...
                            <!-- Title -->
                            <h5 class="s-24 w-700 mb-20">Mission</h5>

                            <!-- Text -->
                            <p>We are dedicated to crafting a dependable and distinctive platform tailored to your
                                e-commerce venture, empowering you to steer your business towards unprecedented success
                                and profitability. Be Professional offers an adaptable e-commerce solution designed to
                                cater
                                to the diverse needs of businesses, ensuring scalability and efficiency. Our commitment
                                extends to assisting small and medium-sized business owners and retailers at every
                                juncture, guiding them towards a brighter future and fostering growth in their
                                enterprises.
                            </p>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div id="a3-2" class="txt-block">
                            ...
                            <!-- Title -->
                            <h5 class="s-24 w-700 mb-20">Vision</h5>

                            <!-- Text -->
                            <p>Our vision is to establish a comprehensive ecosystem that offers security and support to
                                every small and medium business owner, instilling confidence in them to transition their
                                operations online and thrive in the global marketplace. We aim to bridge the gap between
                                small and medium business owners, their products/services, and lucrative business
                                opportunities, thereby creating a cohesive network that fosters growth and success.
                            </p>
                        </div>
                    </div> <!-- END ABOUT-3 TEXT -->
                </div> <!-- End row -->
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-9">
                        <div class="brands-title mb-50">
                            <h5 class="s-20">Trusted and used by over 10000 plus brand</h5>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center row-cols-1 row-cols-md-2">
                        ...
                        <div class="col">
                            <div id="rw-2-1" class="review-2 bg--white-100 block-shadow r-08">
                                ...
                                <div class="review-txt">
                                    ...
                                    <!-- Text -->
                                    <p>
                                        I wanted to thank you for the excellent service you provided during our tenure
                        ...
                        <div class="col">
                            <div id="rw-2-4" class="review-2 bg--white-100 block-shadow r-08">
                                ...
                                <!-- Text -->
                                <div class="review-txt">
                                    <h2 class="s-20 w-700">Best Service Provider</h2>
                                    <!-- Text -->
                                    <p>
